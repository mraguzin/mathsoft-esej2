...
\begin{table}[t]
    ...
    sa GCC 12 (-O3) na Linuxu 6.1.14.}\label{tbl}
    \begin{tabular}{|c|c|c|}
    \hline
    ...
    \end{tabular}
\end{table}
Na kraju sabiremo sva obavljenja mjerenja implementiranih algoritama u tablicu~\ref{tbl}. Vidimo da se možda najviše isplati koristiti neku varijantu
...
\begin{lstlisting}[label=code:asm1]
	...
	movd	eax, xmm4
\end{lstlisting}
Dakle, tu se radi o jednostavnoj \verb|move| instrukciji, koja je na x86/x64 dozvoljena između općih i XMM (SIMD FPU) registara. Ovo je dakle
