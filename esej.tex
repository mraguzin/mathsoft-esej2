...
U ovom odjeljku ćemo razmatrati neke novije pristupe računu korijena, pri čemu mislimo na algoritme prilagođene
...
\begin{figure}[h]
    ...
    decorate] (0,0) -- (15,0) node [pos=0.5,anchor=north,yshift=-0.5cm] {$32$ bita}; 
    \draw [thick,
    decoration={
        brace,
        raise=0.2cm,
    ...
    decorate] (0,1) -- (1,1) node [pos=0.5,anchor=north,yshift=1cm] {$1$ bit}; 
    \draw [thick,
    decoration={
        brace,
        raise=0.2cm,
    ...
    decorate] (1,1) -- (5,1) node [pos=0.5,anchor=north,yshift=1cm] {$8$ bita}; 
    \draw [thick,
    decoration={
        brace,
        raise=0.2cm,
    ...
    decorate] (5,1) -- (15,1) node [pos=0.5,anchor=north,yshift=1cm] {$23$ bita}; 

    \node at (0.5,0.5) {$P$};
    \node at (3,0.5) {$\textcolor{red}{E}$};
    \node at (10,0.5) {$\textcolor{green}{M}$};
    \end{tikzpicture}
\end{figure}
