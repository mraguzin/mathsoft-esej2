...
U ovom odjeljku ćemo razmatrati neke novije pristupe računu korijena, pri čemu primarno mislimo na algoritme prilagođene
...
\end{equation}
Bitno je da osiguramo konvergenciju; indukcijom po $k$ je lako provjeriti da ako $y^2<x<1$ i npr.\ $\alpha=-1/2$, tada svi
$c_k>0$ i taj niz monotono pada, što znači da konvergira ka $0$. Dualno, imamo da ako krenemo s negativnim brojem, niz ostaje negativan
i konvergira ka $0$. Ipak, želimo postići \emph{što bržu} konvergenciju; za kvadratnu je dovoljno odabrati $\alpha=-1/n$~\cite{gower}.
...
što je više moguće (do gornje granice duljine riječi), obaviti račun i na kraju skalirati natrag. Faktor skaliranja treba biti parna potencija od $2$,
kako bi račun korijena bez gubitka prepolovio eksponent.

\subsection{Algoritam znamenka-po-znamenka}
